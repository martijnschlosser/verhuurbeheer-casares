...
export const metadata: Metadata = {
  title: "Bedankt voor je aanvraag | Verhuurbeheer Casares",
...
export default function BedanktPage() {
  return (
    <main className="thanks-page">
      ...
      <a className="thanks-logo" href="/" aria-label="Terug naar Verhuurbeheer Casares">
        <img src="/vbs-logo-casares.webp" alt="Verhuurbeheer Casares" width="62" height="62" />
      </a>
      ...
      <p className="thanks-footer">Verhuurbeheer Casares · Costa del Sol</p>
    </main>
  );
}
