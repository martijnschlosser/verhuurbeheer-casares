...
const services = [
  ...
  },
  {
    ...
    slug: "langetermijnverhuur-casares",
  ...
  },
  {
    ...
    slug: "schoonmaak-onderhoud-casares",
  ...
  },
  {
    ...
    slug: "renovatie-inrichting-casares",
...
const faqs = [
  [
    "How much does holiday rental management in Casares cost?",
  ...
  [
    ...
    "Of course. We block your own stays in advance and align the rental strategy with the periods when you want to visit Casares.",
  ],
  [
  ...
  [
    "Which areas of Casares do you cover?",
    "We support owners in Casares Pueblo, Casares Costa, La Cala de Casares, Bahía de Casares, Marina de Casares, Casares Golf, La Perla de la Bahía and Miraflores. Every property and location is assessed individually.",
  ],
  [
    "Do I need a rental licence for holiday rentals in Casares?",
...
function LocalizedHome() {
  ...
  const schema = {
    ...
    description:
      "Full-service property management, holiday rental management and second-home care for owners in Casares.",
    parentOrganization: {
      "@type": "Organization",
    ...
    areaServed: [
      ...
      { "@type": "Place", name: "Casares Pueblo" },
      { "@type": "Place", name: "Casares Costa" },
      { "@type": "Place", name: "La Cala de Casares" },
      { "@type": "Place", name: "Bahía de Casares" },
      { "@type": "Place", name: "Marina de Casares" },
      { "@type": "Place", name: "Casares Golf" },
      { "@type": "Place", name: "La Perla de la Bahía" },
    ...
    url: absoluteUrl("/es/"),
    logo: absoluteUrl("/vbs-logo-casares.webp"),
    image: absoluteUrl("/terras-zonsondergang-casares.webp"),
    sameAs: [
    ...
    <main lang="es">
      ...
      <header className="site-header">
        <a
          ...
          href="/"
          aria-label="Property Management Casares – Home"
        >
          <img
            src="/vbs-logo-casares.webp"
            alt="Property Management Casares logo"
            width="54"
            height="54"
          />
        </a>
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-casares/">Gestión de alquiler vacacional</a>
              <a href="/midterm-verhuur-casares/">
                Alquiler de temporada
              </a>
              <a href="/langetermijnverhuur-casares/">Alquiler de larga duración</a>
              <a href="/vastgoedbeheer-casares/">Gestión de propiedades</a>
              <a href="/schoonmaak-onderhoud-casares/">
                Limpieza y mantenimiento
              </a>
              <a href="/renovatie-inrichting-casares/">
                Reforma y decoración
              </a>
              <a href="/verhuurlicentie-casares/">Licencia de alquiler</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Servicios</b>
            <a href="/vakantieverhuur-casares/">Gestión de alquiler vacacional</a>
            <a href="/midterm-verhuur-casares/">Alquiler de temporada</a>
            <a href="/langetermijnverhuur-casares/">Alquiler de larga duración</a>
            <a href="/vastgoedbeheer-casares/">Gestión de propiedades</a>
            <a href="/schoonmaak-onderhoud-casares/">Limpieza y mantenimiento</a>
            <a href="/renovatie-inrichting-casares/">Reforma y decoración</a>
            <a href="/verhuurlicentie-casares/">Licencia de alquiler</a>
            <b>Company</b>
            <a href="/werkwijze/">Cómo trabajamos</a>
            <a href="/over-ons/">Quiénes somos</a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Disfruta de tu segunda residencia en Casares. Nosotros nos ocupamos del resto.</h1>
          <p>
            From Casares Costa and La Cala to Casares Pueblo, we combine smart rental management with trusted local people. You have one clear contact for bookings, guests, cleaning, maintenance and the day-to-day care of your property.
          </p>
        ...
        <div className="hero-stats">
          ...
          <span>
            <CheckCircle2 aria-hidden="true" />
            <b>Local service</b> in Casares and the surrounding area
          </span>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Homes and property in Casares"
      >
        <figure className="showcase-wide">
          <img
            src="/villa-zwembad-casares.webp"
            alt="Modern villa in Casares with terrace, pool and sea views"
            width="1536"
            height="1024"
            loading="eager"
          />
        ...
        <figure>
          <img
            src="/villa-zwembad-casares.webp"
            alt="Holiday home on the Casares coast"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure>
          <img
            src="/terras-zonsondergang-casares.webp"
            alt="Luxury holiday home in Casares with sea views"
            width="1600"
            height="1200"
            loading="lazy"
          />
      ...
      <aside className="license-note">
        ...
        <a href="/verhuurlicentie-casares/">Read about rental licensing →</a>
      </aside>
      ...
      <section className="rental-band">
        ...
        <div className="rental-options">
          <a href="/vakantieverhuur-casares/">
          ...
          <a href="/langetermijnverhuur-casares/">
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Conocimiento local en todo Casares</h2>
          <p>
            From coastal apartments and golf townhouses to hillside villas, we work throughout Casares Pueblo, La Cala de Casares, Casares Costa, Bahía de Casares, Miraflores, Marina de Casares and Casares Golf.
          </p>
        </div>
        <div className="area-list" aria-label="Areas covered around Casares">
          <b>Casares Pueblo</b>
          <b>Casares Costa</b>
          <b>La Cala de Casares</b>
          <b>Bahía de Casares</b>
          <b>Marina de Casares</b>
          <b>Casares Golf</b>
          <b>Fuengirola</b>
          <b>Benalmádena</b>
        </div>
      ...
      <section className="home-team">
        <div className="home-team-copy">
          ...
          <h2>Personal contact with people who know Casares.</h2>
          <p>
      ...
      <section className="knowledge compact-knowledge" id="kennisbank">
        <div className="section-head">
          ...
          <p>
            Clear guidance on costs, rental strategy, regulations and property management in Casares.
          </p>
        </div>
        <div className="knowledge-grid">
          <a href="/kosten-verhuurbeheer-casares/">
            <small>Costs</small>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            Key questions about our services and fees in Casares.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <section className="contact" id="contact">
        <div>
          ...
          <h2>Recibe una previsión de alquiler para tu vivienda en Casares</h2>
          <p>
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          <a className="logo-lockup" href="/" aria-label="Home">
            <img
              src="/vbs-logo-casares.webp"
              alt="Property Management Casares"
              width={640}
              height={640}
              sizes="54px"
            />
            <span>
              Verhuurbeheer <b>Casares</b>
            </span>
          </a>
          <p>
            Property Management Casares is part of{" "}
        ...
        <div>
          ...
          <small>© 2026 · Casares · Costa del Sol</small>
        </div>
      </footer>
      <a
...
export const metadata = { robots: { index: false, follow: true }, keywords: ["gestión de propiedades Casares","gestión de alquiler vacacional Casares","gestión de Airbnb Casares","custodia de llaves Casares","revisión de viviendas Casares","gestión de segunda residencia Casares","mantenimiento de viviendas Casares","administración de propiedades Casares"], title: "Gestión de Propiedades en Casares | Alquiler Vacacional y Llaves", description: "Gestión local de propiedades en Casares: alquiler vacacional, gestión de Airbnb, custodia de llaves, revisiones, limpieza y mantenimiento.", alternates: { canonical: "/es/", languages: { "nl-NL": "/", en: "/en/", es: "/es/", "x-default": "/" } }, openGraph: { locale: "es_ES", url: "/es/", type: "website" as const } };
