...
const faqs = [
  ...
  [
    ...
    "Ayudamos a propietarios en Casares Pueblo, Casares Costa, La Cala de Casares, Bahía de Casares, Marina de Casares, Casares Golf, La Perla de la Bahía and Miraflores. Cada vivienda y ubicación se valora individualmente.",
  ],
  [
    ...
    <main lang="es">
      ...
      <section classNombre="hero" id="top">
        ...
        <div classNombre="hero-inner">
          ...
          <p>
            Desde Casares Costa and La Cala to Casares Pueblo, combinamos una gestión inteligente con profesionales locales de confianza. Tienes un único contactoo para reservas, huéspedes, limpieza, mantenimiento y cuidado diario de la vivienda.
          </p>
      ...
      <section classNombre="regions compact-regions" id="regios">
        <div classNombre="section-head">
          ...
          <p>
            Desdeal apartments and golf townhouses to hillside villas, we work throughout Casares Pueblo, La Cala de Casares, Casares Costa, Bahía de Casares, Miraflores, Marina de Casares and Casares Golf.
          </p>
        </div>
        <div classNombre="area-list" aria-label="Zonas atendidas alrededor de Casares">
          <b>Casares Pueblo</b>
          <b>Casares Costa</b>
      ...
      <section classNombre="home-team">
        <div classNombre="home-team-copy">
          ...
          <h2>Personal contacto with people who know Casares.</h2>
          <p>
