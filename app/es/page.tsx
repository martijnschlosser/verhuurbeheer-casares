    ...
    <main lang="es">
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <p>
            Desde Casares Costa y La Cala to Casares Pueblo, combinamos una gestión inteligente con profesionales locales de confianza. Tienes un único contacto para reservas, huéspedes, limpieza, mantenimiento y cuidado diario de la vivienda.
          </p>
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <p>
            Desdeal apartments y golf townhouses to hillside villas, we work throughout Casares Pueblo, La Cala de Casares, Casares Costa, Bahía de Casares, Miraflores, Marina de Casares y Casares Golf.
          </p>
        </div>
