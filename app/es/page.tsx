...
const faqs = [
  [
    "¿Cuánto cuesta la gestión de alquiler vacacional en Casares?",
  ...
  [
    ...
    "Por supuesto. Bloqueamos tus estancias con antelación y adaptamos la estrategia a los periodos en que quieras visitar Casares.",
  ],
  [
  ...
  [
    "¿En qué zonas de Casares trabajáis?",
    "Ayudamos a propietarios en Casares Pueblo, Casares Costa, La Cala de Casares, Bahía de Casares, Marina de Casares, Casares Golf, La Perla de la Bahía y Miraflores. Cada vivienda y ubicación se valora individualmente.",
  ],
  [
    "¿Necesito licencia turística para alquilar vacacionalmente en Casares?",
...
function LocalizedHome() {
  ...
  const schema = {
    ...
    description:
      "Gestión integral de propiedades, alquiler vacacional y cuidado de segundas residencias para propietarios en Casares.",
    parentOrganization: {
      "@type": "Organization",
    ...
    knowsAbout: [
      "Gestión de propiedades Casares",
    ...
    <main lang="es">
      ...
      <header className="site-header">
        <a
          ...
          href="/"
          aria-label="Gestión de propiedades Casares – Home"
        >
          <img
            src="/vbs-logo-casares.webp"
            alt="Gestión de propiedades Casares logo"
            width="54"
            height="54"
          />
        </a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <p>
            Desde Casares Costa y La Cala hasta Casares Pueblo, combinamos una gestión inteligente con profesionales locales de confianza. Tienes un único contacto para reservas, huéspedes, limpieza, mantenimiento y cuidado diario de la vivienda.
          </p>
        ...
        <div className="hero-stats">
          ...
          <span>
            <CheckCircle2 aria-hidden="true" />
            <b>Servicio local</b> in Casares y alrededores
          </span>
        </div>
      </section>
      ...
      <section
        ...
        aria-label="Viviendas y propiedades en Casares"
      >
        <figure className="showcase-wide">
          <img
            src="/villa-zwembad-casares.webp"
            alt="Villa moderna en Casares con terraza, piscina y vistas al mar"
            width="1536"
            height="1024"
            loading="eager"
          />
        ...
        <figure>
          <img
            src="/villa-zwembad-casares.webp"
            alt="Vivienda vacacional en la costa de Casares"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure>
          <img
            ...
            alt="Vivienda vacacional de lujo en Casares con vistas al mar"
            width="1600"
            height="1200"
            loading="lazy"
          />
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <p>
            Desdeal apartments y golf townhouses hasta hillside villas, we work throughout Casares Pueblo, La Cala de Casares, Casares Costa, Bahía de Casares, Miraflores, Marina de Casares y Casares Golf.
          </p>
        </div>
        <div className="area-list" aria-label="Zonas atendidas alrededor de Casares">
          <b>Casares Pueblo</b>
          <b>Casares Costa</b>
      ...
      <section className="home-team">
        <div className="home-team-copy">
          ...
          <h2>Contacto personal con profesionales que conocen Casares.</h2>
          <p>
      ...
      <section className="knowledge compact-knowledge" id="kennisbank">
        <div className="section-head">
          ...
          <p>
            Información clara sobre costes, estrategia de alquiler, normativa y gestión de propiedades en Casares.
          </p>
        </div>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            Preguntas clave sobre nuestros servicios y tarifas en Casares.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          <a className="logo-lockup" href="/" aria-label="Home">
            <img
              src="/vbs-logo-casares.webp"
              alt="Gestión de propiedades Casares"
              width={640}
              height={640}
              sizes="54px"
            />
          ...
          <p>
            Gestión de propiedades Casares forma parte de{" "}
