...
const seoH1BySlug: Record<string, string> = {
  "vakantieverhuur-casares": "Vakantieverhuur in Casares vanaf 18%",
  "midterm-verhuur-casares": "Midterm verhuur in Casares",
  "langetermijnverhuur-casares": "Langetermijnverhuur in Casares",
  "vastgoedbeheer-casares": "Vastgoedbeheer in Casares",
  "schoonmaak-onderhoud-casares": "Schoonmaak en onderhoud in Casares",
  ...
  "verhuurlicentie-casares":
    "Verhuurlicentie in Casares aanvragen en controleren",
  "over-ons": "Over Verhuurbeheer Casares",
  werkwijze: "Werkwijze voor verhuurbeheer in Casares",
  contact: "Contact met Verhuurbeheer Casares",
  "woning-aanmelden": "Woning aanmelden voor verhuurbeheer in Casares",
  blog: "Blogs over verhuurbeheer in Casares",
};
...
Object.assign(relatedBySlug, {
  "vocht-ventilatie-kustwoning-casares": ["vastgoedbeheer-casares","schoonmaak-onderhoud-casares","tweede-woning-beheer-casares","kustwoning-laagseizoen-beheren-casares","kosten-verhuurbeheer-casares"],
  "vastgoedbeheer-casares": ["vocht-ventilatie-kustwoning-casares", ...(relatedBySlug["vastgoedbeheer-casares"] ?? []).filter((slug) => slug !== "vocht-ventilatie-kustwoning-casares")].slice(0, 6),
  "schoonmaak-onderhoud-casares": ["vocht-ventilatie-kustwoning-casares", ...(relatedBySlug["schoonmaak-onderhoud-casares"] ?? []).filter((slug) => slug !== "vocht-ventilatie-kustwoning-casares")].slice(0, 6),
...
const contentVisualBySlug: Record<string, { src: string; alt: string }> = {
  "vakantieverhuur-casares": {
    ...
    alt: "Luxe vakantiewoning in Casares met lichte woonkamer en uitzicht op zee",
  },
  "midterm-verhuur-casares": {
    src: "/luxe-interieur-casares.webp",
    alt: "Licht ingericht appartement voor seizoens- en midtermverhuur in Casares",
  },
  "langetermijnverhuur-casares": {
    src: "/luxe-interieur-casares.webp",
    alt: "Verzorgd interieur van een woning voor langetermijnverhuur in Casares",
  },
  "vastgoedbeheer-casares": {
    src: "/villa-zwembad-casares.webp",
    alt: "Zwembad en mediterrane tuin bij een professioneel beheerde villa in Casares",
  },
  "schoonmaak-onderhoud-casares": {
    src: "/luxe-interieur-casares.webp",
    alt: "Schoon en verzorgd interieur van een beheerde woning in Casares",
  },
  "renovatie-inrichting-casares": {
    src: "/terras-zonsondergang-casares.webp",
    alt: "Luxe terras van een ingerichte woning in Casares bij zonsondergang",
  },
  werkwijze: {
    src: "/zonnig-terras-zeezicht-casares.webp",
    alt: "Zonnig terras van een beheerde vakantiewoning in Casares met zeezicht",
  },
};
...
> = {
  "kosten-verhuurbeheer-casares": {
    src: "/vastgoed-aan-zee-casares.webp",
    alt: "Woningen aan zee bij Casares als illustratie bij de kosten van verhuurbeheer",
    category: "Kosten & tarieven",
    readTime: "4 min",
  },
  "dynamische-prijzen-vakantiewoning": {
    src: "/luxe-woning-casares-zeezicht.webp",
    alt: "Luxe vakantiewoning met zeezicht in Casares voor een blog over dynamische prijzen",
    category: "Opbrengst",
    readTime: "4 min",
  },
  "zelf-verhuren-of-verhuurbeheer": {
  ...
  "verhuurlicentie-casares": {
    src: "/casares-hero.webp",
    alt: "Uitzicht over Casares bij informatie over de verhuurlicentie",
...
export default async function ContentRoute({
  ...
  const organization = {
    ...
    logo: {
      "@type": "ImageObject",
      url: absoluteUrl("/vbs-logo-casares.webp"),
    },
  };
  const pageSchema =
    page.type === "gids"
  ...
  const trustItems =
    page.slug === "langetermijnverhuur-casares"
      ? [
          <>
      ...
      : page.slug === "vastgoedbeheer-casares"
        ? [
            <>
    ...
    <main className="content-page" id="top">
      ...
      <header className="content-header">
        <a
          className="brand"
          href="/"
          aria-label="Verhuurbeheer Casares – naar Home"
        >
        ...
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-casares/">Vakantieverhuur</a>
              <a href="/midterm-verhuur-casares/">
                Seizoens- en midtermverhuur
              </a>
              <a href="/langetermijnverhuur-casares/">Langetermijnverhuur</a>
              <a href="/vastgoedbeheer-casares/">Vastgoedbeheer</a>
              ...
              <a href="/verhuurlicentie-casares/">Verhuurlicentie</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Diensten</b>
            <a href="/vakantieverhuur-casares/">Vakantieverhuur</a>
            <a href="/midterm-verhuur-casares/">Seizoens- en midtermverhuur</a>
            <a href="/langetermijnverhuur-casares/">Langetermijnverhuur</a>
            <a href="/vastgoedbeheer-casares/">Vastgoedbeheer</a>
            <a href="/schoonmaak-onderhoud-casares/">Schoonmaak & onderhoud</a>
            <a href="/renovatie-inrichting-casares/">Renovatie & inrichting</a>
            <a href="/verhuurlicentie-casares/">Verhuurlicentie</a>
            <b>Bedrijf</b>
            <a href="/werkwijze/">Werkwijze</a>
            <a href="/over-ons/">Over ons</a>
      ...
      <section className="content-hero">
        ...
        <aside>
          ...
          <strong>{page.price ?? "Casares · Costa del Sol"}</strong>
          <p>
        ...
        <section className="signup-experience" id="woningformulier">
          <div className="signup-story">
            ...
            <div className="signup-photo">
              ...
              <span>Casares · Costa del Sol</span>
            </div>
          ...
          <FormSubmit className="signup-form" action={leadFormAction} thankYouPath={siteConfig.template.thankYouPath}>
            ...
            <label>Locatie woning<input name="locatie" placeholder="Bijv. Casares Costa, Doña Julia of Casares Pueblo" required /></label>
        ...
        <section className="contact contact-page-form" id="woningformulier">
          ...
          <FormSubmit action={leadFormAction} thankYouPath={siteConfig.template.thankYouPath}>
            ...
            <label>
              ...
              <input
                name="locatie"
                placeholder="Bijv. Casares Costa of Casares Pueblo"
                required
              />
            </label>
            <label>
      ...
      {page.slug === "blog" && featuredBlog ? (
        <section
          ...
          aria-label="Alle blogs over verhuurbeheer in Casares"
        >
      ...
      {page.slug === "verhuurlicentie-casares" && (
      ...
      {page.slug !== "blog" && page.slug !== "contact" && page.slug !== "woning-aanmelden" && (
        <section className="related">
          ...
          <h2>Meer voor eigenaren in Casares</h2>
          <div>
            {related.map((r) => (
        ...
        <section className="blog-lead">
          ...
          >
            ...
            <label>
              ...
              <input
                name="locatie"
                placeholder="Bijv. Casares, Casares Costa of Manilva"
              />
            </label>
            <label className="wide">
              Je vraag
      ...
      <footer className="site-footer">
        <div className="footer-brand">
          ...
          <p>
            Verhuurbeheer Casares is onderdeel van{" "}
        ...
        <div>
          ...
          <a href="/vastgoedbeheer-casares/">Vastgoedbeheer</a>
          <a href="/verhuurlicentie-casares/">Verhuurlicentie</a>
          <a href="/nederlandse-verhuurmakelaar-casares/">Nederlandse verhuurmakelaar</a>
          <a href="/sleutelbeheer-casares/">Sleutelbeheer</a>
          <a href="/appartement-verhuren-casares/">Appartement verhuren</a>
          <a href="/villa-verhuren-casares/">Villa verhuren</a>
          <a href="/airbnb-beheer-casares/">Airbnb & Booking beheer</a>
          <a href="/tweede-woning-beheer-casares/">Tweede woning beheer</a>
        </div>
        <div>
          <b>Meer</b>
          <a href="/werkwijze/">Werkwijze</a>
