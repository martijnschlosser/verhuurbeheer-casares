...
const services = [
  {
    ...
    icon: BedDouble,
    text: "Complete vakantieverhuur voor woningen aan Casares Costa en rond het pueblo: presentatie, boekingen, prijzen, gastencontact en lokale uitvoering.",
  },
  {
  ...
  },
  {
    ...
    price: "Maatwerk",
    icon: ShieldCheck,
    text: "Woningcontroles, sleutelbeheer en praktische opvolging in Casares, ook wanneer je zelf langere tijd niet aan de Costa del Sol bent.",
  },
  {
    ...
    icon: Sparkles,
    text: "Wisselschoonmaak, linnen, inspecties en coördinatie van onderhoud door lokale partners rond Casares.",
  },
  {
...
const faqs = [
  [
    "Wat kost vakantieverhuurbeheer in Casares?",
  ...
  [
    "In welke delen van Casares zijn jullie actief?",
    "We ondersteunen eigenaren in Casares Pueblo, Casares Costa, Doña Julia, Bahía de Casares, Marina de Casares, Finca Cortesin en La Perla de la Bahía. De mogelijkheden bekijken we altijd per woning.",
  ],
  [
    "Heb ik een verhuurlicentie nodig voor vakantieverhuur in Casares?",
...
export default function Home() {
  ...
  const schema = {
    ...
    description:
      "Nederlandstalig fullservice verhuurbeheer, vakantieverhuurbeheer en vastgoedbeheer voor woningeigenaren in Casares.",
    parentOrganization: {
      "@type": "Organization",
    ...
    <main>
      ...
      <header className="site-header">
        ...
        >
          <img
            ...
            alt="Logo Verhuurbeheer Casares"
            width="54"
            height="54"
          />
        </a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Geniet van je tweede huis in Casares, wij regelen de rest.</h1>
          <p>
      ...
      <section
        ...
        aria-label="Mediterrane woningen en sfeer in Casares"
      >
        <figure className="showcase-wide">
          <img
            src="/vastgoed-aan-zee-casares.webp"
            alt="Witte mediterrane woningen aan zee in Casares"
            width="1200"
            height="800"
            loading="eager"
          />
        ...
        <figure className="showcase-pool">
          <img
            ...
            alt="Zwembad met palmen en mediterrane tuin bij een villa in Casares"
            width="1800"
            height="1118"
            loading="lazy"
          />
        ...
        <figure className="showcase-garden">
          <img
            src="/urbanisatie-zwembad-casares.webp"
            alt="Witte urbanisatie met groene tuin en zwembad in Casares"
            width="1600"
            height="1067"
            loading="lazy"
          />
        ...
        <figure className="showcase-terrace">
          <img
            ...
            alt="Zonnig terras met zeezicht in Casares"
            width="1600"
            height="1067"
            loading="lazy"
          />
      ...
      <section className="services" id="diensten">
        <div className="section-head">
          ...
          <h2>Alles voor je woning in Casares</h2>
          <p>
      ...
      <aside className="license-note">
        ...
        <a href="/verhuurlicentie-casares/">Lees over de verhuurlicentie →</a>
      </aside>
      ...
      <section className="owner-experience" aria-label="De beleving van professioneel woningbeheer">
        ...
        <figure className="owner-experience-main">
          <img
            src="/woning-casares-zeezicht.webp"
            alt="Verzorgde woning in Casares met uitzicht op zee"
            width="1200"
            height="800"
            loading="lazy"
          />
        ...
        <figure className="owner-experience-detail">
          <img
            src="/woning-interieur-casares.webp"
            alt="Licht en verzorgd interieur van een woning in Casares"
            width="1200"
            height="800"
            loading="lazy"
          />
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Lokaal actief in Casares Pueblo en Casares Costa</h2>
          <p>
            Van het witte dorp Casares tot de kust, Doña Julia, Bahía de
            Casares, Marina de Casares en Finca Cortesin.
          </p>
        </div>
        <div className="area-list" aria-label="Werkgebieden rond Casares">
          <b>Casares Pueblo</b>
          <b>Casares Costa</b>
          <b>Doña Julia</b>
      ...
      <section className="faq">
        <div>
          ...
          <p>
            De belangrijkste vragen over onze diensten en tarieven in Casares.
          </p>
        </div>
        <div>
          {homeFaqs.map(([q, a], i) => (
      ...
      <section className="home-owner-cta" id="woning-aanmelden">
        <div className="home-owner-cta-image" role="img" aria-label="Zonnig terras met uitzicht op zee in Casares" />
        <div className="home-owner-cta-copy">
          <p className="kicker orange">Vrijblijvend kennismaken</p>
          <h2>Klaar om meer uit je woning in Casares te halen?</h2>
          <p>
