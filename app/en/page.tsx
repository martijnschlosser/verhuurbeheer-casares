    ...
    <main lang="en">
      ...
      <header className="site-header">
        ...
        <nav>
          ...
          <details className="services-menu">
            ...
            <div>
              <a href="/vakantieverhuur-casares/">Holiday rental management</a>
              <a href="/midterm-verhuur-casares/">
                Seasonal and mid-term rentals
              </a>
              <a href="/langetermijnverhuur-casares/">Long-term rentals</a>
              <a href="/vastgoedbeheer-casares/">Property management</a>
              ...
              <a href="/verhuurlicentie-casares/">Rental licence</a>
            </div>
          </details>
        ...
        <details className="mobile-menu">
          ...
          <div>
            ...
            <b>Services</b>
            <a href="/vakantieverhuur-casares/">Holiday rental management</a>
            <a href="/midterm-verhuur-casares/">Seasonal and mid-term rentals</a>
            <a href="/langetermijnverhuur-casares/">Long-term rentals</a>
            <a href="/vastgoedbeheer-casares/">Property management</a>
            <a href="/schoonmaak-onderhoud-casares/">Cleaning & maintenance</a>
            <a href="/renovatie-inrichting-casares/">Renovation & furnishing</a>
            <a href="/verhuurlicentie-casares/">Rental licence</a>
            <b>Company</b>
            <a href="/werkwijze/">How we work</a>
            <a href="/over-ons/">About us</a>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-inner">
          ...
          <h1>Enjoy your second home in Casares. We take care of the rest.</h1>
          <p>
      ...
      <section className="regions compact-regions" id="regios">
        <div className="section-head">
          ...
          <h2>Local knowledge across Casares</h2>
          <p>
      ...
      <section className="contact" id="contact">
        <div>
          ...
          <h2>Get an informed rental forecast for Casares</h2>
          <p>
...
export const metadata = { robots: { index: false, follow: true }, keywords: ["property management Casares","holiday rental management Casares","Airbnb management Casares","key holding Casares","home checks Casares","second home management Casares","villa management Casares","apartment management Casares"], title: "Property Management Casares | Holiday Rental & Key Holding", description: "Local property management in Casares for international owners: holiday rental management, Airbnb management, key holding, home checks, cleaning and maintenance.", alternates: { canonical: "/en/", languages: { "nl-NL": "/", en: "/en/", es: "/es/", "x-default": "/" } }, openGraph: { locale: "en_GB", url: "/en/", type: "website" as const } };
