export const siteConfig = {
  ...
  seo: {
    ...
    longTailKeywords: [
      ...
      "appartement laten verhuren in Casares met beheer",
      "villa laten verhuren in Casares met Nederlandstalige beheerder",
      "tweede woning beheren op afstand in Casares",
      "sleutelbeheer voor tweede woning in Casares",
      "Airbnb en Booking beheer in Casares",
      "rendement vakantiewoning in Casares",
      "property management in Casares voor Nederlandse eigenaren",
      "wat kost verhuurbeheer in Casares",
    ],
  },
  analytics: {
